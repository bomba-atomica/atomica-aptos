 ...
 */
export async function performCleanup(reason) {
 ...
 */
export function setGlobalTestnet(testnet) {
    globalTestnet = testnet;
}
/**
 * Get the global testnet instance
 */
export function getGlobalTestnet() {
 ...
 */
export async function initializeTestnet(numValidators) {
 ...
 */
export async function waitForNetworkStabilization(testnet) {
...
//# sourceMappingURL=testnet-lifecycle.js.map